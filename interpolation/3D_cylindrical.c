...
double
linterpolate(double x, double xa, double xb, double ya, double yb){
...
double
findvalue(double x, double y, double z, const double arr[NCELLS]){
    ...
    int zidx_a = verticalbounds(alt, c3arr[aidx-1], c1arr[ridx_a-1]);
